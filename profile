...
.profile_frame{
	...
	.profile_picture{
		...
		height: 240px;
		margin:10px;
		background: url(image.jpeg) 100% /210px no-repeat;
	}
...
<!-- MAIN CONTAINER -->
      ...
      <div id="header">
        ...
        <div class="header_logotype_container">
          <h1 class="logotype_name"> <span class="purple">sree purvaja.k</span></h1>
        ...
        <div class="header_menu_container">
          ...
          <ul class="header_menu horizontal_list">
            ...
            <li><a href="#">technical skill</a></li>
      ...
      <!-- LEFT COL -->
        ...
        <div class="profile_frame">
          <div class="profile_picture"><p class="w3-center"><img src="sree (2).jpeg"class="w3-circle" style="height:225px;width:220px" alt="Avatar"></p>
          
        </div>
        <div class="hello_content">
          <h2>Hello!</h2>
          <p>I'm a b.tech Artificial intelligence and data science student with a creative mind and crazy ideas. I am interested in learning new skills. I utilizing my skills and work towords my personal and professional growth .</p>
        </div>
        <div class="contact_details_content">
          ...
          <p>ksreepurvaja@gmail.com</p>
          <p class="purple">Adress:</p>
          <p>coimbatore</p>
          <p>tamil nadu,india</p>
          <p>641606</p>
        </div>
        <a href="mailto:ksreepurvaja@gmail.com" class="send_message_button">
      ...
      <div id="content_container">				
        ...
        <div class="block">
          <h2>EDUCATION</h2>
          <p>2021 - 2025
			  B.TECH AD<br>KPR institute of engineering and technology<br> 2021<br> HSE<br> century foundation matric hr.sec.school<br> 2019<br> SSLC<br> century foundation matric hr.sec. school.<ADdress></ADdress>
